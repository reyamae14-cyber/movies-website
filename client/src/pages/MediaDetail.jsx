      ...
      <>
        ...
        <Box sx={{ color: "primary.contrastText", ...uiConfigs.style.mainContent }}>
          ...
          <div ref={videoRef} style={{ paddingTop: "2rem" }}>
            {showCustomPlayer ? (
              <Container header={`Watch ${mediaType === "movie" ? "Movie" : "TV Show"}`}>
                <Box sx={{ mb: 2 }}>
                  <Button 
                    variant="outlined" 
                    size="small"
                    ...
                    sx={{ mb: 2 }}
                  >
                    Show Trailers Instead
                  </Button>
                </Box>
                <CustomVideoPlayer 
                  mediaType={mediaType}
                  mediaId={mediaId}
                  seasonNumber={mediaType === "tv" ? currentSeason : null}
                  episodeNumber={mediaType === "tv" ? currentEpisode : null}
                />
                {/* TV Season Selector */}
